        ...
        <div ref={ref} className="fade-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-line border border-line mb-12">
            <div className="stagger bg-surface p-10 lg:p-12">
              <p className="text-[11px] font-semibold tracking-[0.24em] text-dim uppercase mb-8">
                Philosophy
              </p>
              ...
              <p className="mt-6 text-[15px] leading-7 text-dim">
            ...
            <div className="stagger bg-coal p-10 lg:p-12">
              <p className="text-[11px] font-semibold tracking-[0.24em] text-smoke uppercase mb-8">
                Problem Solving
              </p>
              ...
              <p className="mt-6 text-[15px] leading-7 text-smoke">
                DB 연결, 동시성, 응답 지연 문제를
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="stagger border-t border-line pt-6">
              ...
              <p className="text-[15px] leading-7 text-dim">
